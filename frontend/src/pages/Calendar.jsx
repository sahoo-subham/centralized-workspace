  ...
  return (
    <div className="min-h-full bg-[#0A0D16] p-4 md:p-6 text-slate-100">
      ...
      <style>{`
        ...
        /* Month view grid: force every cell dark, including overflow days */
        .calendar-dark .fc-scrollgrid,
        .calendar-dark .fc-scrollgrid-section > *,
        .calendar-dark table,
        .calendar-dark .fc-daygrid-body,
        ...
        .calendar-dark .fc-day-other {
          background: rgba(255,255,255,0.015) !important;
        }

        /* Hover feedback on a day cell */
        .calendar-dark .fc-daygrid-day:hover .fc-daygrid-day-frame {
          background: rgba(255,255,255,0.03);
        }

        /* Today: pill-style date badge instead of a full-cell wash */
        .calendar-dark .fc-daygrid-day.fc-day-today {
        ...
        /* "+N more" link chip */
        .calendar-dark .fc-daygrid-more-link {
          color: #a5b4fc;
          font-weight: 600;
        ...
        /* "+N more" popover (previously default white) */
        ...
        .calendar-dark .fc-popover-close {
          color: #94a3b8;
        }
        .calendar-dark .fc-popover-body {
