      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <p style={{ color: '#fff', fontWeight: '700', fontSize: '20px', margin: 0 }}>Upload Document</p>
              <p style={{ color: '#94a3b8', fontSize: '13px', marginTop: '4px' }}>Attach a file to a project.</p>
            </div>
          </div>
        ...
        <div style={{ padding: '28px 32px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input type="text" value={title} onChange={(e) => setTitle(e.target.value)}
              placeholder="e.g. Project Requirements" style={inputStyle}
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div
              ...
              style={{
                ...
                border: file ? '1px solid rgba(99,102,241,0.5)' : '1px dashed #3f4659',
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                {file ? (
                  <>
                    <p style={{ color: '#a5b4fc', fontSize: '13px', fontWeight: '600', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{file.name}</p>
                    <p style={{ color: '#6b7280', fontSize: '11px', margin: '2px 0 0' }}>{(file.size / 1024).toFixed(1)} KB</p>
                  </>
                ) : (
                  <p style={{ color: '#6b7280', fontSize: '13px', margin: 0 }}>Click to choose a file</p>
                )}
              </div>
              {file && (
                <button
                  onClick={(e) => { e.stopPropagation(); setFile(null) }}
                  style={{ background: 'transparent', border: 'none', color: '#f87171', fontSize: '16px', cursor: 'pointer', flexShrink: 0 }}
                >✕</button>
              )}
            </div>
            <input
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', paddingTop: '16px', borderTop: '1px solid #2d3348' }}>
            ...
            <button onClick={handleSubmit} disabled={loading}
              ...
              onMouseEnter={e => { if (!loading) e.currentTarget.style.background = '#4338ca' }} onMouseLeave={e => { if (!loading) e.currentTarget.style.background = '#4f46e5' }}
